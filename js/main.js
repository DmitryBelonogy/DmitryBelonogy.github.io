...
class myGame {
    ...
    static addMenu() {
        document.getElementsByTagName('body')[0].innerHTML = '<div id="menuPanel"><div id="content"></div><div id="navigation"><ul><li><button id="about">About</button></li><li><button id="bestPlayers">Best palyers</button></li><li><button id="recordGame">Record last game</button></li></ul></div></div><div id="menu"><img src="img/settings.png" alt="menu"></div><div id="pause"><img src="img/pause.png" alt="pause"></div>';
    }
}
